    ...
    <footer className="border-t border-[var(--color-border-subtle)] bg-[var(--color-bg-primary)]">
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold text-[var(--color-text-white)] mb-6 flex items-center gap-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { name: "כדורגל", color: "#10b981" },
                { name: "כדורסל", color: "#3b82f6" },
                { name: "טניס", color: "#8b5cf6" },
                { name: "הוקי", color: "#06b6d4" },
                { name: "MMA / UFC", color: "#ef4444" },
                { name: "בייסבול", color: "#f97316" },
              ].map((sport) => (
                <li key={sport.name} className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full flex-shrink-0" style={{ background: sport.color }} />
                  <span className="text-sm text-[var(--color-text-muted)]">{sport.name}</span>
                </li>
              ))}
            </ul>
          </div>
        ...
        {/* Disclaimer */}
        <div className="mt-14 p-6 rounded-2xl bg-[var(--color-bg-card)] border border-[var(--color-border-subtle)]">
        ...
        {/* Copyright */}
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-[var(--color-text-dim)]">
