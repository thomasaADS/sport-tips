...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      {/* Button */}
      <div className="w-14 h-14 rounded-2xl bg-[var(--color-whatsapp)] flex items-center justify-center shadow-xl hover:scale-110 transition-all duration-300 relative">
        <div className="absolute inset-0 rounded-2xl bg-[var(--color-whatsapp)] animate-ping opacity-20" />
